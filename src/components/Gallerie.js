...
function Gallerie() {
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-5 md:flex-row justify-center">
      <img src={plattarte} alt="" className="w-3/5 md:w-1/4" data-aos="fade-up"></img>
      <img src={platsaladefromage} alt="" className="w-3/5 md:w-1/4" data-aos="fade-up"></img>
      <img src={platcourgette} alt="" className="w-3/5 md:w-1/4" data-aos="fade-up"></img>
    </div>


    <div className="hidden md:flex justify-center gap-5" >
      <img src={platgastronomique} alt="" className="w-1/4"data-aos="fade-up"></img>
      <img src={platpoisson} alt="" className="w-1/4"data-aos="fade-up"></img>
      <img src={platpoischiche} alt="" className="w-1/4"data-aos="fade-up"></img>
    </div>
